...
\title{CS 147: Lab 04 \\ Due Date: March 24, 2026}
\author{}
\date{March 10, 2026}
\begin{document}
\maketitle
...
\item Assemble using:
\textit{(This is one command broken into multiple lines.)}
\begin{verbatim}
./run assemble assignments/hw04/<subproblem>/<test_name>.asm \
  assignments/hw04/<subproblem>/<test_name>
\end{verbatim}
...
\begin{verbatim}
prompt% ./run assemble assignments/hw04/hw4_1/add_0.asm assignments/hw04/hw4_1/add_0
