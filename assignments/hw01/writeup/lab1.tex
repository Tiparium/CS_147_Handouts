...
Feel free to refer
to the Verilog cheatsheet, Verilog tutorial slides linked off of canvas. 
...
To run the testbench programs that we have distributed for this lab, run the following command in the
top-level folder where you have checked out the code:
\begin{verbatim}
./run test hw1 hw1_1
\end{verbatim}

This will run the test(s) for problem 1. For more help, look at the \texttt{run} script. If you want
more detailed output, add \texttt{-v} (for example, \texttt{./run test -v hw1 hw1\_1}).

\section*{Submission Instructions}
Read the Verilog rules document in the assignments folder (see \texttt{Verilog Rules.pdf}) and adhere to the conventions.

\textbf{Fill this in: How to run the rule checker?  How do I submit?}
