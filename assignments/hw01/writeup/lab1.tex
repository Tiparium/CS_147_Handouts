...
\item IMPORTANT: Running \texttt{./run build\_submission <assignment>} DOES NOT actively submit your assignment, it only generates the file you will submit. This file must be manually uploaded to Gradescope.
\end{itemize}
