...
def main() -> int:
    ...
    print("[PLACEHOLDER]:")
    print("If you see this, this assignment has not yet received official points.")
    print("Try running [git pull], followed by [./run setup] to grab any updates and retry.")
    print("If this does not fix the problem, the TA has not yet implemented the grader.")
    print("-----------------------")
    for note in notes:
        print(note)
