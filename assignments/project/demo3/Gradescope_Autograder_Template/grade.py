...
CONFIG = {
    ...
    "assignment_name": "project_phase_3",
    "total_points": 800.0,
...
SUMMARY_NAME = str(CONFIG.get("summary_name", "project_phase_3_grade_summary.json"))
...
def compute_phase_scores(summary: Dict) -> Tuple[float, float, List[str]]:
    ...
    if MODE == "count_remap":
        ...
        notes.append("Scoring policy: Phase 3 full-suite count/remap")
        notes.append(f"Supplied tests: {baseline_pass}/{baseline_total} passed")
