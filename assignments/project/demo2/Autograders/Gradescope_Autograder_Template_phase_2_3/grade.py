...
CONFIG = {
    "phase": "phase_2_3",
    "summary_name": "project_phase_2_3_grade_summary.json",
    "assignment_name": "project_phase_2_3",
    "total_points": 267.0,
    "required_student_tests": 2,
    "mode": "weighted_buckets",
    "baseline_points": 67.0,
    "specialized_points": 150.0,
    "student_custom_points": 50.0,
}
