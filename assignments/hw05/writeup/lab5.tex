...
\title{CS 147: Lab 05 \\ Due Date: April 16, 2026}
\author{}
\date{}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{src/cache_sontroller_FSM_template.png}
\caption{Example cache controller FSM template.}
\end{figure}
...
Digitally created diagrams are strongly preferred.
